...
let afterCat = document.querySelector("#aftercat")
...
async function main () {
    ...
    if(
        ...
        afterCat.append(miseEnForme(text.listofpageshtml[13].en))
        ...
        afterCat.append(miseEnForme(text.listofpageshtml[13].fr))
